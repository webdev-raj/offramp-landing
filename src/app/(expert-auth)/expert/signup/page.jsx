...
import ExpertSignupMultiStepForm from "@/components/expert-auth/ExpertSignupMultiStepForm";
  ...
  return (
    <main className="min-h-screen flex flex-col lg:flex-row bg-[#F5A623] relative overflow-hidden selection:bg-[#1B2264] selection:text-white">
      ...
      <ExpertAuthSidePanel
        ...
        titleWord1="BECOME"
        titleWord2="AN EXPERT."
        subtext="Share your expertise with thousands of Indian households navigating their food and health. Apply to become a verified OffRamp expert."
      />
     ...
     <div className="hidden lg:block rotate-180 absolute top-0 bottom-0 left-[48.1%] -translate-x-[50%] z-5 h-full w-[50px] pointer-events-none">
      ...
      {/* ════ RIGHT PANEL (Multi-Step Form Area) ═══════════════════════════ */}
