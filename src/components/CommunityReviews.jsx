  ...
  return (
    <section className="relative bg-[#FCF6E8] py-20 lg:py-28 px-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        {/* Section Header */}
        <div className="mb-14">
          <p className="flex items-center gap-2 text-[#DC346b] text-xs sm:text-sm font-extrabold tracking-[0.22em] uppercase mb-3">
            <svg width="22" height="22" viewBox="1.6 1.6 13.4 13.4" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path opacity="0.3" d="M8.35903 12.5381C10.6672 12.5381 12.5384 10.667 12.5384 8.35879C12.5384 6.0506 10.6672 4.17944 8.35903 4.17944C6.05084 4.17944 4.17969 6.0506 4.17969 8.35879C4.17969 10.667 6.05084 12.5381 8.35903 12.5381Z" stroke="#DC346b" stroke-width="0.23882" />
            </svg>
            <span>COMMUNITY ACTIVITY</span>
          </p>
          <h2 className="font-anton text-5xl sm:text-6xl lg:text-7xl leading-[1.1] tracking-tight">
